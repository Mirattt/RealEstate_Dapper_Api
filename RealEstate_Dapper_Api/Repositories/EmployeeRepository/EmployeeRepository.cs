...
namespace RealEstate_Dapper_Api.Repositories.EmployeeRepository
{
    public class EmployeeRepository : IEmployeeRepository
    {
        ...
        public async void CreateEmployee(CreateEmployeDto createEmployeDto)
        {
            ...
            parameters.Add("@name", createEmployeDto.Name);
            parameters.Add("@title", createEmployeDto.Title);
            parameters.Add("@mail", createEmployeDto.Mail);
            parameters.Add("@phoneNumber", createEmployeDto.PhoneNumber);
            parameters.Add("@imageUrl", createEmployeDto.ImageUrl);
        ...
        public async Task<List<ResultEmployeDto>> GetAllEmployeeAsync()
        {
