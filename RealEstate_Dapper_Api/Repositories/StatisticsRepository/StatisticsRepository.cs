...
namespace RealEstate_Dapper_Api.Repositories.StatisticsRepository
{
    ...
    public class StatisticsRepository : IStatisticsRepository
    {
        ...
        {
            string query = "Select Avg(Price) From Product where Description='Kiralik'";
            using (var connection = _context.CreateConnection())
            {
        ...
        {
            string query = "Select Avg(Price) From Product where Description='Satilik'";
            using (var connection = _context.CreateConnection())
            {
                var values = connection.QueryFirstOrDefault<decimal>(query);
                return values;
